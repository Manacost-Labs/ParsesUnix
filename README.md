...
| **Bright Data** | резерв высокой надёжности | `unlocker` / `unlocker_render` / `browser` | по документации |

Ключей Firecrawl и Bright Data у проекта нет — их адаптеры написаны по живой
документации (`docs_verified_at` в каждом файле), но **вживую не измерены**.
